...
Figure \@ref(fig:toprank) presents the share of respondents ranking the fairest asylum-seeker allocation mechanism across information conditions. Most respondents (70% or more) ranked proportional relocation mechanisms, either by GDP or population, as fairer than no relocation across all the information conditions, with allocation based on GDP receiving the highest share in the no information group (39%), followed closely by allocation based on population (35%). In the control group, only 26% considered no relocation to be the fairest option. A one-sample proportion test shows that this result is significantly lower (p<0.01) than the 33% expected if individuals were ranking alternatives at random or were indifferent among the options.

Figure \@ref(fig:toprank) also reveals substantial variation across information conditions and between net sender and net receiver countries. In the absolute and relative information groups, only 13% and 17% of respondents from net sender countries perceived no relocation as the fairest mechanism, compared with 27% and 24% in the no-information group. By contrast, 34% and 28% of respondents from net receiver countries perceived no relocation as the fairest option. This pattern points to a strong effect of information provision, as well as a pronounced divergence between net senders and net receivers, consistent with a self-serving bias.
...
```{r, fig.cap = "TBA", fig.asp = .5, fig.width = 7, include = F}
library(brms)
library(broom.mixed)
