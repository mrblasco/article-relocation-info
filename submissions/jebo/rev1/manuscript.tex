...
Our analysis indicates that nearly three-quarters of participants favour some form of relocation as a fair approach. However, there are important country differences. This finding suggests a tendency for participants to view as fairer relocation methods that result in fewer asylum seekers for their own country (``self-serving bias''). Moreover, this study demonstrates that alternative communication strategies can significantly moderate this tendency. Specifically, presenting the likely consequences of the implementation of each method in absolute terms --- reporting how many asylum seekers are expected in the participants' country per year --- significantly reinforces the self-serving bias. In contrast, the same information presented in relative terms, rescaling the expected asylum seekers by the residents' population (i.e., asylum seekers per 100,000 inhabitants), appears to reduce the bias.
...
\begin{figure}
\includegraphics[width=\textwidth]{/Users/mrb/Research/migrant_relocation_fairness/docs/main_files/figure-latex/toprank-1} \caption[Fairest asylum-seeker allocation mechanism.]{Fairest asylum-seeker allocation mechanism. Share of respondents selecting the top-ranked relocation mechanism across information conditions}\label{fig:toprank}
\end{figure}
...
\begin{figure}
\includegraphics[width=\textwidth]{/Users/mrb/Research/migrant_relocation_fairness/docs/main_files/figure-latex/political-1} \caption{Heterogeneous Treatment Effects by Political orientation. Coefficients and 95\% confidence intervals from rank-ordered regression on the probability of ranking an alternative relocation shceme as fairer, stratified by the self-reported political orientation.}\label{fig:political}
\end{figure}
...
{\centering \includegraphics[width=0.75\textwidth]{/Users/mrb/Research/migrant_relocation_fairness/docs/main_files/figure-latex/rologit-base-1} 
