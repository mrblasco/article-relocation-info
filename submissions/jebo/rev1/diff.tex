...
%DIF DEL submissions/jebo/initial/manuscript.tex   Thu May 14 13:28:16 2026
%DIF ADD submissions/jebo/rev1/manuscript.tex      Thu May 14 15:33:10 2026
...
\date{This version: \DIFdelbegin \DIFdel{Apr 30}\DIFdelend \DIFaddbegin \DIFadd{May 14}\DIFaddend , 2026}
...
\DIFdelbegin \DIFdel{We find }\DIFdelend \DIFaddbegin \DIFadd{Our analysis indicates }\DIFaddend that nearly three-quarters of participants \DIFdelbegin \DIFdel{find }\DIFdelend \DIFaddbegin \DIFadd{favour }\DIFaddend some form of relocation \DIFdelbegin \DIFdel{most fair }\DIFdelend \DIFaddbegin \DIFadd{as a fair approach}\DIFaddend . However, there are important country differences. \DIFdelbegin \DIFdel{These are consistent with a }\DIFdelend \DIFaddbegin \DIFadd{This finding suggests a tendency for participants to view as fairer relocation methods that result in fewer asylum seekers for their own country (``}\DIFaddend self-serving \DIFdelbegin \DIFdel{bias: the tendency to judge the method that results in relatively few asylum seekers in one's own country as fairer}\DIFdelend \DIFaddbegin \DIFadd{bias'')}\DIFaddend . Moreover, \DIFdelbegin \DIFdel{communication strategies randomised as treatments }\DIFdelend \DIFaddbegin \DIFadd{this study demonstrates that alternative communication strategies can }\DIFaddend significantly moderate this tendency. \DIFdelbegin \DIFdel{Explicitly spelling out }\DIFdelend \DIFaddbegin \DIFadd{Specifically, presenting }\DIFaddend the likely consequences of the implementation of each method in absolute terms \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin \DIFadd{--- reporting }\DIFaddend how many asylum seekers are expected in the participants' country per year \DIFdelbegin \DIFdel{) significantly strengthens }\DIFdelend \DIFaddbegin \DIFadd{--- significantly reinforces }\DIFaddend the self-serving bias. \DIFdelbegin \DIFdel{The }\DIFdelend \DIFaddbegin \DIFadd{In contrast, the }\DIFaddend same information presented in relative terms\DIFdelbegin \DIFdel{(how many asylum seekers are to be expected }\DIFdelend \DIFaddbegin \DIFadd{, rescaling the expected asylum seekers by the residents' population (i.e., asylum seekers }\DIFaddend per 100,000 inhabitants), \DIFdelbegin \DIFdel{showing that the number of asylum seekers is small compared to the entire population, has a weaker effect}\DIFdelend \DIFaddbegin \DIFadd{appears to reduce the bias}\DIFaddend .
...
\DIFaddbegin \DIFadd{This debate can be framed within the discussion of the Equity Theory, originally formulated by Adams (\mbox{%DIFAUXCMD
\citeproc{ref-adams1965inequity}{1965}}\hskip0pt%DIFAUXCMD
). This framework posits that individuals evaluate the fairness of a situation by comparing the ratio of their own inputs and outcomes to those of others. In the context of asylum seekers redistribution, this translates into a demand for ``proportionality,'' where the perceived burden must be balanced against a country's capacity or resources to maintain social and political equilibrium (\mbox{%DIFAUXCMD
\citeproc{ref-thielemann2003between}{Thielemann, 2003}}\hskip0pt%DIFAUXCMD
). When a distribution method is perceived as inequitable -e.g.~when one country feels it is bearing a disproportionate share of the responsibility relative to its neighbours- it creates a state of distress, leading to policy resistance or non-compliance (\mbox{%DIFAUXCMD
\citeproc{ref-walster1978equity}{Walster et al., 1978}}\hskip0pt%DIFAUXCMD
). Consequently, policy outcomes in the European Union often reflect an attempt to restore this perceived equity through the implementation of ``distribution keys'' based on objective criteria such as GDP and population size (\mbox{%DIFAUXCMD
\citeproc{ref-eu2024pact}{European Commission, 2024}}\hskip0pt%DIFAUXCMD
). These mechanisms aim to align individual country preferences with collective outcomes.
}
...
A sample representative of the adult population \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin \DIFadd{aged }\DIFaddend 18 years and over \DIFdelbegin \DIFdel{) }\DIFdelend in eight EU countries (Bulgaria, France, Germany, Greece, Italy, Poland, Spain and Sweden) was drawn from Ipsos online panel by means of stratified random probability sampling. The \DIFaddbegin \DIFadd{selected countries were chosen to ensure a balanced representation of the European Union's diversity, with particular attention to coverage across macro-regions (Northern, Southern, Eastern, and Western Europe). The selection also reflects variation in key structural characteristics, including economic conditions (GDP per capita), population size, and the share of foreign-born residents.
}

\DIFadd{The }\DIFaddend stratification leveraged available profile data, such as respondents' age, gender and geographic region (NUTS 1), and pre-defined sub-sample sizes (quota) based on official population statistics provided by Eurostat. The overall sample size of the project included 8,122 participants. The main fieldwork took place between 30 September 2024 and 21 October 2024. Details of the field work and survey design are available elsewhere (\DIFaddbegin \DIFadd{see }\DIFaddend \citeproc{ref-blasco2025fairness}{Blasco et al., 2025}).
...
\DIFdelbegin \DIFdel{Table \ref{tab:example} illustrates the experiment with a simplified scenario involving }\DIFdelend \DIFaddbegin \DIFadd{To illustrate the underlying relocation problem captured by our experiment, we discuss the situation of }\DIFaddend two countries, \DIFdelbegin \DIFdel{Country A and Country B. }\footnote{\DIFdel{This scenario is for illustrative purposes; it was not discussed with participants in the experiment.}} %DIFAUXCMD
\addtocounter{footnote}{-1}%DIFAUXCMD
\DIFdel{Both countries have the same GDP, but Country A has more residents, while Country B received more than twice as many asylum applications , on average, in }\DIFdelend \DIFaddbegin \DIFadd{Poland and Greece. While Poland has a larger population, Greece has handled more than double the average number of asylum applications over }\DIFaddend the past ten years (\DIFdelbegin \DIFdel{2014-2023). As a result, Country A }\DIFdelend \DIFaddbegin \DIFadd{2014 - 2023). Under a system of proportional relocation, Poland }\DIFaddend will experience more asylum applications\DIFdelbegin \DIFdel{under proportional relocation than under no relocation. Furthermore, since countries are equally rich, but Country A is more densely populated, the difference in relocation outcomes will be greater under population-based relocation than under GDP-based relocation.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Under this scenario, study participants from Country A assigned to the absolute-information condition would be informed that their country would host 15}\DIFdelend , \DIFdelbegin \DIFdel{000 asylum seekers under no relocation, 30,000 under relocation by population, and 25,000 under relocation by GDP. In the relative information condition, the same information for Country A would be expressed per 100,000 citizens, with the provided values being 100, 200, and 167, respectively. This example illustrates that, while presenting information about asylum applications in absolute terms can involve large numbers, expressing them as relative figures often shows that the actual impact is modest. It also shows that for each relocation rule, some countries (here, both for relocation based on population and GDP, it is Country A) receive more asylum seekers than in the baseline. }\DIFdelend \DIFaddbegin \DIFadd{than under no relocation. }\DIFaddend We will call such countries ``net receivers''. \DIFdelbegin \DIFdel{Remaining countries (here, Country B) receive fewer , becoming }\DIFdelend \DIFaddbegin \DIFadd{The opposite would hold true for Greece where any form of proportional relocation will result in fewer applications. We call such countries }\DIFaddend ``net senders''.
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
%DIFDELCMD < \label{tab:example}%%%
\DIFdelFL{Illustrative example for two countries}}
%DIFAUXCMD
%DIFDELCMD < \centering
%DIFDELCMD < \begin{tabu} to \linewidth {>{\raggedright\arraybackslash}p{10em}>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X>{\raggedleft}X}
%DIFDELCMD < \toprule
%DIFDELCMD < \multicolumn{1}{c}{} & \multicolumn{2}{c}{Country A} & \multicolumn{2}{c}{Country B} & \multicolumn{1}{c}{All} \\
%DIFDELCMD < \cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5} \cmidrule(l{3pt}r{3pt}){6-6}
%DIFDELCMD <  & Abs. & Rel. & Abs. & Rel. & \\
%DIFDELCMD < \midrule
%DIFDELCMD < \addlinespace[0.3em]
%DIFDELCMD < \multicolumn{6}{l}{\textbf{Hypothetical situation:}}\\
%DIFDELCMD < \hspace{1em}\em{Average yearly asylum applications (2014-23)} & 15.0K & 100 & 35.0K & 350 & 50.0K\\
%DIFDELCMD < \addlinespace\hline\hspace{1em}\em{Most recent population} & 15.0M & 100.0K & 10.0M & 100.0K & 25.0M\\
%DIFDELCMD < \addlinespace\hline\hspace{1em}\em{Most recent GDP} & 1.0B & 6.7M & 1.0B & 10.0M & 2.0B\\
%DIFDELCMD < \addlinespace\hline\addlinespace[0.3em]
%DIFDELCMD < \multicolumn{6}{l}{\textbf{Information treatment:}}\\
%DIFDELCMD < \hspace{1em}\em{No relocation} & 15.0K & 100 & 35.0K & 350 & 50.0K\\
%DIFDELCMD < \addlinespace\hline\hspace{1em}\em{Relocation by population} & 30.0K & 200 & 20.0K & 200 & 50.0K\\
%DIFDELCMD < \addlinespace\hline\hspace{1em}\em{Relocation by GDP} & 25.0K & 166.7 & 25.0K & 250 & 50.0K\\
...
%DIFDELCMD < %%%
\DIFdelend In Table \ref{tab:asylum-per-capita}, we report the actual figures for the expected asylum applications in each country under each information condition used in the experiment. They are based on population, GDP, and historical (2014-2023) asylum applications statistics.
...
\DIFdelbegin \DIFdel{The }\DIFdelend \DIFaddbegin \DIFadd{It is important to point out that, GDP and population are intended as proxies for a country's reception and processing capacity, consistent with existing EU allocation proposals and policy debates (\mbox{%DIFAUXCMD
\citeproc{ref-thielemann2018refugee}{Thielemann, 2018}}\hskip0pt%DIFAUXCMD
). These indicators also provide respondents with clear and easily interpretable signals of a country's size and wealth, which, as research shows, are commonly used when evaluating ``fairness'' in international sharing (\mbox{%DIFAUXCMD
\citeproc{ref-kleider2019politics}{Kleider and Stoeckel, 2019}}\hskip0pt%DIFAUXCMD
). Even so, respondents may interpret the proportionality by GDP or population in different ways (e.g., a proxy for housing capacity or labour market conditions), which may conflate the meaning of ``capacity'' and limit the interpretation of the results.
}

\DIFadd{Finally, the }\DIFaddend survey included several modules that asked respondents about their socio-demographics, perceptions of the EU asylum system, support for different migration policies, and other background questions. The full questionnaire is in the Appendix. A descriptive analysis of the responses is presented in the technical report by Blasco et al. (\citeproc{ref-blasco2025fairness}{2025}). In our analysis, we included control variables such as trust or political affiliation, as these are associated with attitudes towards migration (e.g., \citeproc{ref-canetti2016threatened}{Canetti et al., 2016}; \citeproc{ref-mitchell2021social}{Mitchell, 2021}). We also consider various socio-demographic factors, such as income and employment status, gender, age, and the parents' country of birth. Whether the respondent was born abroad may be relevant because foreigners may hold different opinions on migration issues than natives (\citeproc{ref-berlinschi2019migrants}{Berlinschi and Harutyunyan, 2019}).
...
\DIFaddbegin \subsection{\DIFadd{Fair share and political leanings}}\label{fair-share-and-political-leanings}

\begin{itemize}
\tightlist
\item
  \DIFadd{TODO: I can look at measures of fairness self-reported correlated with left-right
}\item
  \DIFadd{TODO: Left-right vs fairness. Fair share of migrants.
}\end{itemize}
...
\begin{figure}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{/Users/mrb/Research/migrant_relocation_fairness/draft/first-revision/main_files/figure-latex/toprank-1} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{/Users/mrb/Research/migrant_relocation_fairness/docs/main_files/figure-latex/toprank-1} \DIFaddendFL \caption[Fairest asylum-seeker allocation mechanism.]{Fairest asylum-seeker allocation mechanism. Share of respondents selecting the top-ranked relocation mechanism across information conditions}\label{fig:toprank}
\end{figure}
...
\begin{figure}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{/Users/mrb/Research/migrant_relocation_fairness/draft/first-revision/main_files/figure-latex/mean-rank-1} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{/Users/mrb/Research/migrant_relocation_fairness/docs/main_files/figure-latex/mean-rank-1} \DIFaddendFL \caption[Mean differences in fairness rankings]{Information provision \DIFdelbeginFL \DIFdelFL{effects on }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{and }\DIFaddendFL fairness rankings. \DIFdelbeginFL \DIFdelFL{Mean difference and }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Points show mean differences in fairness rankings (with }\DIFaddendFL 95\% confidence intervals\DIFdelbeginFL \DIFdelFL{in fairness rankings }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{) }\DIFaddendFL between individuals \DIFdelbeginFL \DIFdelFL{in the }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{receiving }\DIFaddendFL absolute or relative information \DIFdelbeginFL \DIFdelFL{group }\DIFdelendFL and those \DIFdelbeginFL \DIFdelFL{in the }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{receiving }\DIFaddendFL no information\DIFdelbeginFL \DIFdelFL{group}\DIFdelendFL . \DIFdelbeginFL \DIFdelFL{A lower rank means a }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Lower ranks indicate }\DIFaddendFL higher perceived fairness\DIFdelbeginFL \DIFdelFL{of the allocation mechanims}\DIFdelendFL . \DIFdelbeginFL \DIFdelFL{Net receivers }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Countries }\DIFaddendFL are \DIFdelbeginFL \DIFdelFL{countries with an }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{classified as net receivers if }\DIFaddendFL expected \DIFdelbeginFL \DIFdelFL{number of }\DIFdelendFL asylum applications \DIFdelbeginFL \DIFdelFL{that is }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{are }\DIFaddendFL higher under relocation \DIFaddbeginFL \DIFaddFL{than under no relocation }\DIFaddendFL (based on \DIFdelbeginFL \DIFdelFL{either }\DIFdelendFL GDP or population)\DIFdelbeginFL \DIFdelFL{than under no relocation; }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{, and as }\DIFaddendFL net senders \DIFdelbeginFL \DIFdelFL{are the opposite}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{otherwise}\DIFaddendFL .}\label{fig:mean-rank}
\end{figure}
...
\begin{figure}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{/Users/mrb/Research/migrant_relocation_fairness/draft/first-revision/main_files/figure-latex/political-1} %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{/Users/mrb/Research/migrant_relocation_fairness/docs/main_files/figure-latex/political-1} \DIFaddendFL \caption{Heterogeneous Treatment Effects by Political orientation. Coefficients and 95\% confidence intervals from rank-ordered regression on the probability of ranking an alternative relocation shceme as fairer, stratified by the self-reported political orientation.}\label{fig:political}
\end{figure}
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \pandocbounded{\includegraphics[keepaspectratio,alt={\label{fig:fair}Heterogeneous Treatment Effects by Perceived Fairness of Migrants' Distribution in the EU. Coefficients and 95\% confidence intervals from rank-ordered regression on the probability of ranking an alternative relocation shceme as fairer, stratified by whether respondents perceive the share of refugees in their country as `too high' or not.}]{/Users/mrb/Research/migrant_relocation_fairness/draft/first-revision/main_files/figure-latex/fair-1.pdf}}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \pandocbounded{\includegraphics[keepaspectratio,alt={\label{fig:fair}Heterogeneous Treatment Effects by Perceived Fairness of Migrants' Distribution in the EU. Coefficients and 95\% confidence intervals from rank-ordered regression on the probability of ranking an alternative relocation shceme as fairer, stratified by whether respondents perceive the share of refugees in their country as `too high' or not.}]{/Users/mrb/Research/migrant_relocation_fairness/docs/main_files/figure-latex/fair-1.pdf}}
\DIFaddendFL \caption{\label{fig:fair}Heterogeneous Treatment Effects by Perceived Fairness of Migrants' Distribution in the EU. Coefficients and 95\% confidence intervals from rank-ordered regression on the probability of ranking an alternative relocation shceme as fairer, stratified by whether respondents perceive the share of refugees in their country as `too high' or not.}
\end{figure}
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \pandocbounded{\includegraphics[keepaspectratio,alt={\label{fig:age}Heterogeneous Treatment Effects by Age. Coefficients and 95\% confidence intervals from rank-ordered regression on the probability of ranking an alternative relocation shceme as fairer, stratified by the respondents' age.}]{/Users/mrb/Research/migrant_relocation_fairness/draft/first-revision/main_files/figure-latex/age-1.pdf}}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \pandocbounded{\includegraphics[keepaspectratio,alt={\label{fig:age}Heterogeneous Treatment Effects by Age. Coefficients and 95\% confidence intervals from rank-ordered regression on the probability of ranking an alternative relocation shceme as fairer, stratified by the respondents' age.}]{/Users/mrb/Research/migrant_relocation_fairness/docs/main_files/figure-latex/age-1.pdf}}
\DIFaddendFL \caption{\label{fig:age}Heterogeneous Treatment Effects by Age. Coefficients and 95\% confidence intervals from rank-ordered regression on the probability of ranking an alternative relocation shceme as fairer, stratified by the respondents' age.}
\end{figure}
...
\begin{figure}
\centering
\DIFdelbeginFL %DIFDELCMD < \pandocbounded{\includegraphics[keepaspectratio,alt={\label{fig:knowledge}Heterogeneous Treatment Effects by Knowledge of the Asylum System. Coefficients and 95\% confidence intervals from rank-ordered regression on the probability of ranking an alternative relocation shceme as fairer, stratified by the self-reported knowledge or awareness of the rules governing the asylum system in the EU.}]{/Users/mrb/Research/migrant_relocation_fairness/draft/first-revision/main_files/figure-latex/knowledge-1.pdf}}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \pandocbounded{\includegraphics[keepaspectratio,alt={\label{fig:knowledge}Heterogeneous Treatment Effects by Knowledge of the Asylum System. Coefficients and 95\% confidence intervals from rank-ordered regression on the probability of ranking an alternative relocation shceme as fairer, stratified by the self-reported knowledge or awareness of the rules governing the asylum system in the EU.}]{/Users/mrb/Research/migrant_relocation_fairness/docs/main_files/figure-latex/knowledge-1.pdf}}
\DIFaddendFL \caption{\label{fig:knowledge}Heterogeneous Treatment Effects by Knowledge of the Asylum System. Coefficients and 95\% confidence intervals from rank-ordered regression on the probability of ranking an alternative relocation shceme as fairer, stratified by the self-reported knowledge or awareness of the rules governing the asylum system in the EU.}
\end{figure}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-adams1965inequity}
\DIFadd{Adams, J.S., 1965. Inequity in social exchange, in: Advances in Experimental Social Psychology. Elsevier, pp. 267--299.
}

\DIFaddend \bibitem[\citeproctext]{ref-alesina2023immigration}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-kleider2019politics}
\DIFadd{Kleider, H., Stoeckel, F., 2019. The politics of international redistribution: Explaining public support for fiscal transfers in the EU. European Journal of Political Research 58, 4--29.
}

\DIFaddend \bibitem[\citeproctext]{ref-konow2003fairest}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-thielemann2003between}
\DIFadd{Thielemann, E.R., 2003. Between interests and norms: Explaining burden-sharing in the european union. Journal of refugee studies 16, 253--273.
}

\DIFaddend \bibitem[\citeproctext]{ref-van2006making}
...
\DIFaddbegin \bibitem[\citeproctext]{ref-walster1978equity}
\DIFadd{Walster, E.H., Walster, G.W., Berscheid, E., Austin, W., Traupmann, J., Utne, M.K., 1978. Equity: Theory and research. Allyn; Bacon.
}
...
{\centering \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.75\textwidth]{/Users/mrb/Research/migrant_relocation_fairness/draft/first-revision/main_files/figure-latex/rologit-base-1} 
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.75\textwidth]{/Users/mrb/Research/migrant_relocation_fairness/docs/main_files/figure-latex/rologit-base-1} 
\DIFaddendFL 
