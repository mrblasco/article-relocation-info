...
\begin{figure}
\includegraphics[width=\textwidth]{/Users/mrb/Research/migrant_relocation_fairness/draft/first-revision/main_files/figure-latex/toprank-1} \caption[Fairest asylum-seeker allocation mechanism.]{Fairest asylum-seeker allocation mechanism. Share of respondents selecting the top-ranked relocation mechanism across information conditions}\label{fig:toprank}
\end{figure}
...
\begin{figure}
\includegraphics[width=\textwidth]{/Users/mrb/Research/migrant_relocation_fairness/draft/first-revision/main_files/figure-latex/mean-rank-1} \caption[Mean differences in fairness rankings]{Information provision effects on fairness rankings. Mean difference and 95\% confidence intervals in fairness rankings between individuals in the absolute or relative information group and those in the no information group. A lower rank means a higher perceived fairness of the allocation mechanims. Net receivers are countries with an expected number of asylum applications that is higher under relocation (based on either GDP or population) than under no relocation; net senders are the opposite.}\label{fig:mean-rank}
\end{figure}
...
\begin{figure}
\includegraphics[width=\textwidth]{/Users/mrb/Research/migrant_relocation_fairness/draft/first-revision/main_files/figure-latex/political-1} \caption{Heterogeneous Treatment Effects by Political orientation. Coefficients and 95\% confidence intervals from rank-ordered regression on the probability of ranking an alternative relocation shceme as fairer, stratified by the self-reported political orientation.}\label{fig:political}
\end{figure}
...
{\centering \includegraphics[width=0.75\textwidth]{/Users/mrb/Research/migrant_relocation_fairness/draft/first-revision/main_files/figure-latex/rologit-base-1} 
